...
namespace DevopsApp.Blazor.Navigation;

public class DevopsAppMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public DevopsAppMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<DevopsAppResource>();
