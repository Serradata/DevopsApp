...
using DevopsApp.Blazor.Components.Layout;
using DevopsApp.Blazor.Navigation;
...
[DependsOn(
    ...
    typeof(DevopsAppHttpApiClientModule),
...
public class DevopsAppBlazorModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(DevopsAppBlazorModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new DevopsAppMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("DevopsApp");
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<DevopsAppBlazorModule>();
        });
    }
